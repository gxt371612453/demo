...
public class PdfReportM1HeaderFooter extends PdfPageEventHelper {
    ...
    public void onEndPage(PdfWriter writer, Document document) {
        ...
        // 1.写入页眉
        ColumnText.showTextAligned(writer.getDirectContent(), Element.ALIGN_LEFT, new Phrase(
                header, fontDetail), document.left(), document.top() + 20, 0);
        ...
        ColumnText
                .showTextAligned(
                        ...
                        footer,
                        (document.rightMargin() + document.right() + document.leftMargin()
